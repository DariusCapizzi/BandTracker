...
SELECT pg_catalog.setval('bands_venues_id_seq', 44, true);
...
COPY venues (id, venue_name, created_at, updated_at) FROM stdin;
34	name of venue	2016-05-13 13:39:33.266	2016-05-13 13:39:33.266
\.
...
SELECT pg_catalog.setval('venues_id_seq', 34, true);
